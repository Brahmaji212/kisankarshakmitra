...
if (!isset($_SESSION['login_status'])) {
  header('location: ../admin2login.php');
}
include '../database.php';
$qry = "select * from admin2list";
  ...
  <div class="page-wrapper chiller-theme toggled">
          ...
          <ul>
            ...
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  <li>
                    <a href="../SuperAdmin/SuperAdmin_list.php">Super Admin

                    </a>
                  </li>
                  <li>
                    <a href="../SuperAdmin/Admindashboard.php">Admin</a>
                  </li>
            ...
            <!-- <li class="sidebar-dropdown">
              <a href="../dashboard/customardashboard.php">
                <i class="far fa-user"></i>
                <span>Customers</span>
              </a>
            </li> -->
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  <li>
                    <a href="SuperAdmin_customerreg.php">Customer Registration
    ...
    <main class="page-content">
      <div class="container-fluid">
        <h2 style="color:skyblue;">Admin</h2>
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <form method="post" action="../SuperAdmin/adds/addadmin2.php" role="form">
