	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url(images/back.png);">
			<div class="wrap-login100">
				...
				<form class="login100-form " action="Register.php" method="POST" onSubmit="return checkPassword(this)">
                    ...
                    <div class="wrap-input100 ">
						<input class="input100" type="number" id="phn" name="phn" placeholder="phone number" required >
						<span class="focus-input100"></span>
						<span class="symbol-input100">
