	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url(images/back.png);">
			<div class="wrap-login100">
				...
				<form method="POST" action="cart_admin_login.php" class="login100-form " onSubmit="return checkPassword(this)">
...
if ($admincount > 0) {
    while ($row = mysqli_fetch_assoc($sql)) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            window.location.href = 'cart_admin_login.php';
            </script>";
            }
        }
    }
    ...
    echo "
            ...
            // window.location.href = '../cart_admin_Register.php';
            window.location.href = 'cart_admin_login.php';
            </script>";
}
$dbc->close();
