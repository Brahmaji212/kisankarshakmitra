    ...
    <div class=" mt-5">
      <div class="row tm-content-row">
        <div class="col-sm-15 col-md-12 col-lg-12 col-xl-12 tm-block-col">
          ...
          <form action="remove/remove_multiple_admin.php" method="POST" >
              ...
              <?php if ($admincount > 0) { ?>
                ...
                <tbody>
                  ...
                  <tr align="center">
                    ...
                    <?php echo "<td>
                      <a href='remove/remove_admin.php?id=" . $row['id'] . "' class='tm-product-delete-link' onClick=\"javascript: return confirm('Please confirm deletion');\">
            ...
            <!-- adding new admin by super admin -->
             &nbsp;                            
            <?php  if($row1['email']== $username){ ?>
