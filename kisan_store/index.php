...
<head>
	...
	<link href="css/ken-burns.css" rel="stylesheet" type="text/css" media="all" />
                                            ...
                                            <style>
                                                ...
                                                .featured__item:hover .featured__item__pic .info ul a i
                                                {
                                                    display: block;

                                                }
                                                .featured__item:hover .featured__item__pic .info ul a i:hover
                                                {
                                                    display: inline-block;
            ...
            <ul>
                ...
                <li  style="margin-left: 13%;"><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        ...
                        <li  style="margin-left: 13%;"><a href="./shoping-cart.php">Shoping Cart</a></li>
