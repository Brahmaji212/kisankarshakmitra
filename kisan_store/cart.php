...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            <ul>
                <li><a href="#"><i class="fa fa-heart"></i> <span class="span">1</span></a></li>
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            ...
                            <li><a href="cart.php"><i class="fa fa-cart-plus"></i>  <span> <?php echo $cart_value; ?></span> </a></li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <tr>
                                    ...
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
						                    ...
						                    <input type="text" size="4" title="Qty" class="input" value="<?php  $id=$row['id']; echo $qua; ?>" name="input" id="input" max="29" min="0" step="1" style="text-align: center;">
                  ...
                  <?php } else { ?>
                    ...
                    <?php
                    echo '<p align=center style="color:#4a4a4a">
                  <strong><i class="fa fa-database animated faa-horizontal"></i> <br>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        <h5>Cart Total</h5>
                        <ul>
                            <li>Subtotal <span><?php echo "₹".$total*$qua; ?></span></li>
                            <li>Total <span><?php echo "₹".$total*$qua; ?></span></li>
                        </ul>
...
function myFunction() {
  ...
  document.getElementById("input").innerHTML = + x+1;
}
</script>
