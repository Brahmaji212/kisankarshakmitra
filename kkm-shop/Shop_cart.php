...
<head>
    ...
    <link rel="stylesheet" href="../kisan_store/cart_admin/font-awesome-animation-1.1.1/package/css/font-awesome-animation.min.css">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                <a href="backend/login.html"><i class="fa fa-user"></i> LOGIN</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                  ...
                  If you want to add items to your cart. you have to <a href="backend/login.html" style="color: green;">LOGIN</a> </strong></p> <br>';
                    ?>
